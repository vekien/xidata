...
/**
 * todo - this will be replaced and needs updating to use the new in/gear_XXX stuff
 * 
 * The idea is to give it a list of model ids that the Player is wearing and return the
 * correct gear names.
 */
